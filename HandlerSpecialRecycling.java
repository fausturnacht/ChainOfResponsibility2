public class HandlerSpecialRecycling implements WasteHandler {
    private WasteHandler nextHandler;
    
    @Override
    public void handleWaste(Waste waste) {
        if(waste.getType().equalsIgnoreCase("E-waste")){
            System.out.println("Electronic waste assigned to special recycling.");
        }
